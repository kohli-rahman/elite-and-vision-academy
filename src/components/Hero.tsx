        ...
        <div className={`md:w-1/2 ${isLoaded ? 'animate-scale-in' : 'opacity-0'}`} style={{ animationDelay: '0.3s' }}>
          <div className="relative">
            ...
            <div className="glass-card rounded-xl overflow-hidden">
               ...
               <img src="https://idcgmeemtrhjknobwxik.supabase.co/storage/v1/object/public/faculty/general-images/WhatsApp%20Image%202025-05-07%20at%2014.15.36%20(1).jpeg" 
